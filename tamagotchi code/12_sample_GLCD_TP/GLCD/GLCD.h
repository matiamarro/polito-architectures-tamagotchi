...
#define Red_scuro      0x0400//0x30C0//0x990000//0x810E0E
#define Red_chiaro     0xF800//0xFF0000//0xC91212
#define Yellow_chiaro  0xFFC0//0xfcba03//0xECCD00
#define Yellow_scuro   0xA640//0xad8003//0xD2AC14
#define Brown          0x00001F
...
void LCD_DrawRectangle( uint16_t x0, uint16_t y0, uint16_t dimx, uint16_t dimy, uint16_t color);
